<header x-data="{ showBurger: false }" class="px-5 py-9 lg:py-12">
    ...
    <nav class="p-4 flex md:block">
        <div class="mr-auto md:mx-auto flex justify-between items-center">
            <a href="#" class="text-white text-lg font-bold">Кабинет профориентации</a>
            <div class="hidden md:flex space-x-4 text-gray-300">
                <a href="#tests" class="line hover:text-white transition duration-300 relative group">Тесты и
                    опросы</a>
                <a href="#teachers-info"
                    class="line hover:text-white transition duration-300 relative group">Информация для учителей</a>
                <a href="#parents-info"
                    class="line hover:text-white transition duration-300 relative group">Информация для
                    родителей</a>
                <a href="#events" class="line hover:text-white transition duration-300 relative group">События</a>
                <a href="#videos"
                    class="line hover:text-white transition duration-300 relative group">Рекомендованные видео</a>
            </div>
        </div>
                ...
                <ul>
                    <li  @click="showBurger = false" class="mb-1 line">
                        <a class="block p-4 text-sm font-semibold text-gray-300 hover:bg-gray-600 hover:text-white rounded"
                            href="#tests">Тесты и опросы</a>
                    </li>
                    <li  @click="showBurger = false" class="mb-1 line">
                        <a class="block p-4 text-sm font-semibold text-gray-300 hover:bg-gray-600 hover:text-white rounded"
                            href="#teachers-info">Информация для учителей</a>
                    </li>
                    <li  @click="showBurger = false" class="mb-1 line">
                        <a class="block p-4 text-sm font-semibold text-gray-300 hover:bg-gray-600 hover:text-white rounded"
                            href="#parents-info">Информация для родителей</a>
                    </li>
                    <li  @click="showBurger = false" class="mb-1 line">
                        <a class="block p-4 text-sm font-semibold text-gray-300 hover:bg-gray-600 hover:text-white rounded"
                    ...
                    <li  @click="showBurger = false" class="mb-1 line">
                        <a class="block p-4 text-sm font-semibold text-gray-300 hover:bg-gray-600 hover:text-white rounded"
                            href="#videos">Рекомендованные видео</a>
                    </li>
                </ul>
            </div>
        </nav>
